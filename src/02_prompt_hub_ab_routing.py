...
PROMPT_V1_NAME = "phan-tran-tuong-vy-rag-prompt-v1"
PROMPT_V2_NAME = "phan-tran-tuong-vy-rag-prompt-v2"
...
SYSTEM_V1 = (
    ...
    "và giữ câu trả lời ngắn gọn, rõ ràng trong 2-4 câu. Nếu context không có "
    "đủ thông tin, hãy nói thẳng rằng bạn không tìm thấy câu trả lời.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích AI. Chỉ sử dụng các dữ kiện trong context. "
    "Hãy viết câu trả lời có cấu trúc trong 3-5 câu: bắt đầu bằng kết luận chính, "
    "sau đó giải thích các dữ kiện liên quan và kết thúc bằng mức độ chắc chắn. "
    "Không suy đoán khi context không đủ thông tin.\n\nContext:\n{context}"
)
